...
- Node.js 20, matching the repo [`.nvmrc`](../.nvmrc)
- npm или yarn
...
- **Транзакции**
  ...
  - Создание новой транзакции на отдельной странице `/new` без Telegram-специфичных полей.
  - Фильтрация между двумя пользователями (`/transactions/between`).
  - Редактирование комментария и удаление своих транзакций.
